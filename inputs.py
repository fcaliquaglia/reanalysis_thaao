...
extr = {'alb'      : {'name': 'alb', 'ref_x': 't', 'min': 0, 'max': 1, 'res_min': -0.5, 'res_max': 0.5,
                      ...
                      'c'   : {'fn': f'{thaao_c}_albedo_', 'col_nr': 2, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      'e'   : {'fn': f'{thaao_e}_forecast_albedo_', 'col_nr': 2, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      'l'   : {'fn': f'{thaao_l}_forecast_albedo_', 'col_nr': 4, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't'   : {'fn': 'MERGED_SW_LW_UP_DW_METEO_', 'col_nr': 2, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
        ...
        'cbh'      : {'name': 'cbh', 'ref_x': 't', 'min': 0, 'max': 10000, 'res_min': -500, 'res_max': 500,
                      ...
                      'c'   : {'fn': f'{thaao_c}_cloud_base_', 'col_nr': 2, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
        ...
        'temp'     : {'name'   : 'temp', 'ref_x': 't', 'min': -40, 'max': 20, 'res_min': -10,
                      ...
                      'l'      : {'fn'      : f'{thaao_l}_2m_temperature_', 'col_nr': 2, 'data': pd.DataFrame(),
                                  'data_res': pd.DataFrame()},
                      't'      : {'fn': 'Meteo_weekly_all', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'     : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't2'     : {'fn': 'AWS_THAAO_', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()}},
        ...
        'lwp'      : {'name': 'lwp', 'ref_x': 't1', 'min': 0, 'max': 50, 'res_min': -20, 'res_max': 20,
                      ...
                      'c'   : {'fn'      : f'{thaao_c}_total_column_cloud_liquid_water_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'e'   : {'fn'      : f'{thaao_e}_total_column_cloud_liquid_water_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'l'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'  : {'fn': 'LWP_15_min_', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't2'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()}},
        'lw_down'  : {'name': 'lw_down', 'ref_x': 't', 'min': 0, 'max': 500, 'res_min': -20, 'res_max': 20,
                      'uom' : '[W/m2]', 'comps': ['c', 'e'], 'bin_nr': 200,
                      'c'   : {'fn'      : f'{thaao_c}_thermal_surface_radiation_downwards_', 'col_nr': 4, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'e'   : {'fn'      : f'{thaao_e}_surface_thermal_radiation_downwards_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'l'   : {'fn'      : f'{thaao_l}_thermal_surface_radiation_downwards_', 'col_nr': 4, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      't'   : {'fn': 'MERGED_SW_LW_UP_DW_METEO_', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't2'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()}},
        'lw_net'   : {'name': 'lw_down', 'ref_x': 't', 'min': 0, 'max': 500, 'res_min': -20, 'res_max': 20,
                      'uom' : '[W/m2]', 'comps': ['c', 'e'], 'bin_nr': 200,
                      'c'   : {'fn'      : f'{thaao_c}_surface_net_thermal_radiation_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'e'   : {'fn'      : f'{thaao_e}_surface_net_thermal_radiation_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'l'   : {'fn'      : f'{thaao_l}_surface_net_thermal_radiation_', 'col_nr': 4, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      't'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't2'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()}},
        ...
        'sw_down'  : {'name': 'sw_down', 'ref_x': 't', 'min': 0, 'max': 500, 'res_min': -20, 'res_max': 20,
                      'uom' : '[W/m2]', 'comps': ['c', 'e'], 'bin_nr': 200,
                      'c'   : {'fn'      : f'{thaao_c}_surface_solar_radiation_downwards_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'e'   : {'fn'      : f'{thaao_e}_surface_solar_radiation_downwards_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'l'   : {'fn'      : f'{thaao_l}_surface_solar_radiation_downwards_', 'col_nr': 4, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      't'   : {'fn': 'MERGED_SW_LW_UP_DW_METEO_', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't2'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()}},
        'sw_net'   : {'name': 'sw_down', 'ref_x': 't', 'min': 0, 'max': 500, 'res_min': -20, 'res_max': 20,
                      'uom' : '[W/m2]', 'comps': ['c', 'e'], 'bin_nr': 200,
                      'c'   : {'fn'      : f'{thaao_c}_surface_net_solar_radiation_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'e'   : {'fn'      : f'{thaao_e}_surface_net_solar_radiation_', 'col_nr': 2, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      'l'   : {'fn'      : f'{thaao_l}_surface_net_solar_radiation_', 'col_nr': 4, 'data': pd.DataFrame(),
                               'data_res': pd.DataFrame()},
                      't'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't2'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()}},
        ...
        'winds'    : {'name': 'winds', 'ref_x': 't', 'min': 0, 'max': 30, 'res_min': -10, 'res_max': 10,
                      ...
                      'c'   : {'fn': f'{thaao_c}_10m_wind_speed_', 'col_nr': 2, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      'e'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      'l'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't'   : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
                      't1'  : {'fn': '', 'col_nr': np.nan, 'data': pd.DataFrame(), 'data_res': pd.DataFrame()},
