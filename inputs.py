...
# =============================================================
var_dict_template = {'nanval'         : DEFAULTS['nanval'], 'col': DEFAULTS['col'],
                     'rad_conv_factor': DEFAULTS['rad_conv_factor'], 'label_uom': ''}
...
extr = {'alb': {'name' : 'alb', 'ref_x': 't', 'min': 0, 'max': 1, 'res_min': -0.5, 'res_max': 0.5, 'uom': '[none]',
        ...
        'cbh': {'name': 'cbh', 'ref_x': 't', 'min': 0, 'max': 10000, 'res_min': -1500, 'res_max': 1500, 'uom': '[m]',
                'comps': ['c', 'e'], 'bin_nr': 200, 'c': {'fn': f'{thaao_c}_cloud_base_', 'column': 2, 'data': '',
                'data_res'                                    : ''},
        ...
        'dewpt': {'name' : 'dewpt', 'ref_x': '', 'min': '', 'max': '', 'res_min': '', 'res_max': '', 'uom': '[deg]',
                  'comps': [], 'bin_nr': np.nan, 'c': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
        ...
        'tcc': {'name': 'tcc', 'ref_x': 't', 'min': 0, 'max': 1, 'res_min': -50, 'res_max': 50, 'uom': '[octave]',
                'comps': ['c', 'e'], 'bin_nr': 200, 'c': {'fn': f'{thaao_c}_total_cloud_cover_', 'column': 2,
                'data'                                        : '', 'data_res': ''},
