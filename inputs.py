...
datasets = {
    ...
    'buoys': {'switch': True, 'fn': '2024Jprocessed'}, # from J to R, skip O and M
...
list_var =  ['temp', 'surf_pres', 'sw_down', 'sw_up']  # + rad + clouds + extra +  met
...
extr = {'alb': {'name': 'alb', 'ref_x': 't', 'min': 0, 'max': 1,
        ...
        'rh': {'name': 'rh', 'ref_x': 't', 'min': 0, 'max': 100, 'res_min': -10, 'res_max': 10, 'uom': '[%]',
               ...
               'e': {'fn': f'', 'column': np.nan, 'data': '', 'data_res': '', 'var_name': ''},
