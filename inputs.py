...
DEFAULTS = {'nanval': -32767.0, 'rad_conv_factor': 3600, 'col': 'gray', 'small_size': 12, }
...
# =============================================================
var_dict_template = {'nanval'         : DEFAULTS['nanval'], 'col': DEFAULTS['col'], 'label_uom': ''}

var_dict = {'c' : {**var_dict_template, 'label': 'CARRA', 'col_ori': 'orange'},
            'e' : {**var_dict_template, 'label': 'ERA5', 'col_ori': 'cyan'},
...
extr = {'alb': {'name' : 'alb', 'ref_x': 't', 'min': 0, 'max': 1, 'res_min': -0.5, 'res_max': 0.5, 'uom': '[none]',
        ...
        'cbh': {'name': 'cbh', 'ref_x': 't', 'min': 0, 'max': 10000, 'res_min': -1500, 'res_max': 1500, 'uom': '[m]',
                'comps': ['c', 'e'], 'bin_nr': 200,  'excl_thresh':20,'c': {'fn': f'{thaao_c}_cloud_base_', 'column': 2, 'data': '',
                'data_res'                                    : ''},
                'e': {'fn': f'{thaao_e}_cloud_base_height_', 'column': 2, 'data': '', 'data_res': ''},
                'l': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                't': {'fn'    : '_Thule_CHM190147_000_0060cloud', 'column': 'CBH_L1[m]', 'data': pd.DataFrame(),
                    'data_res': ''}, 't1': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                't2': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'dewpt': {'name' : 'dewpt', 'ref_x': '', 'min': '', 'max': '', 'res_min': '', 'res_max': '', 'uom': '[deg]',
                  'comps': [], 'bin_nr': np.nan,  'excl_thresh':'','c': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
        ...
        'lwp': {'name' : 'lwp', 'ref_x': 't1', 'min': 0, 'max': 50, 'res_min': -20, 'res_max': 20, 'uom': '[kg/m2]',
                ...
                'c'    : {'fn': f'{thaao_c}_total_column_cloud_liquid_water_', 'column': 2, 'data': '', 'data_res': ''},
                'e'    : {'fn': f'{thaao_e}_total_column_cloud_liquid_water_', 'column': 2, 'data': '', 'data_res': ''},
                'l'    : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                't'    : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                't1'   : {'fn': 'LWP_15_min_', 'column': np.nan, 'data': '', 'data_res': ''},
                't2'   : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'lw_down': {'name': 'lw_down', 'ref_x': 't', 'min': 100, 'max': 400, 'res_min': -20, 'res_max': 20,
                    'uom': '[W/m2]', 'comps': ['c', 'e', 'l'], 'bin_nr': 200, 'excl_thresh':0, 'rescale_factor':3600,
                    'c': {'fn'    : f'{thaao_c}_thermal_surface_radiation_downwards_', 'column': 4, 'data': '',
                        'data_res': ''},
                    'e': {'fn'      : f'{thaao_e}_surface_thermal_radiation_downwards_', 'column': 2, 'data': '',
                          'data_res': ''},
                    'l': {'fn'      : f'{thaao_l}_surface_thermal_radiation_downwards_', 'column': 4, 'data': '',
                          'data_res': ''},
                    't': {'fn': 'MERGED_SW_LW_UP_DW_METEO_', 'column': 'LW_DOWN', 'data': '', 'data_res': ''},
                    't1': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                    't2': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'lw_net': {'name': 'lw_down', 'ref_x': 't', 'min': 0, 'max': 600, 'res_min': -20, 'res_max': 20,
                   'uom' : '[W/m2]', 'comps': ['c', 'e', 'l'], 'bin_nr': 200, 'excl_thresh':'',
                   'c'   : {'fn': f'{thaao_c}_surface_net_thermal_radiation_', 'column': 4, 'data': '', 'data_res': ''},
                   'e'   : {'fn': f'{thaao_e}_surface_net_thermal_radiation_', 'column': 2, 'data': '', 'data_res': ''},
                   'l'   : {'fn': f'{thaao_l}_surface_net_thermal_radiation_', 'column': 4, 'data': '', 'data_res': ''},
                   't'   : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                   't1'  : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                   't2'  : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'lw_up': {'name' : 'lw_up', 'ref_x': 't', 'min': 100, 'max': 500, 'res_min': -20, 'res_max': 20,
                  ...
                  'e'    : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                  'l'    : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                  't'    : {'fn': 'MERGED_SW_LW_UP_DW_METEO_', 'column': 'LW_UP', 'data': '', 'data_res': ''},
                  't1'   : {'fn': '', 'column': 2, 'data': '', 'data_res': ''},
                  't2'   : {'fn': '', 'column': 2, 'data': '', 'data_res': ''}},
        'msl': {'name' : 'winds', 'ref_x': 't', 'min': 0, 'max': 30, 'res_min': -10, 'res_max': 10, 'uom': '[m/s]',
        ...
        'surf_pres': {'name': 'surf_pres', 'ref_x': 't', 'min': 935, 'max': 1013, 'res_min': -10, 'res_max': 10,
                      'uom' : '[hPa]', 'comps': ['c', 'e', 't2'], 'bin_nr': 200, 'excl_thresh':900, 'rescale_fact':100,
        ...
        'sw_down': {'name': 'sw_down', 'ref_x': 't', 'min': 0, 'max': 700, 'res_min': -20, 'res_max': 20,
                    'uom': '[W/m2]', 'comps': ['c', 'e', 'l'], 'bin_nr': 200, 'excl_thresh':0,'rescale_factor':3600,
                    'c': {'fn'    : f'{thaao_c}_surface_solar_radiation_downwards_', 'column': 4, 'data': '',
                        'data_res': ''},
                    'e': {'fn'      : f'{thaao_e}_surface_solar_radiation_downwards_', 'column': 2, 'data': '',
                          'data_res': ''},
                    'l': {'fn'      : f'{thaao_l}_surface_solar_radiation_downwards_', 'column': 4, 'data': '',
                          'data_res': ''},
                    't': {'fn': 'MERGED_SW_LW_UP_DW_METEO_', 'column': 'SW_DOWN', 'data': '', 'data_res': ''},
                    't1': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                    't2': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'sw_net': {'name': 'sw_down', 'ref_x': 't', 'min': 0, 'max': 600, 'res_min': -20, 'res_max': 20,
                   'uom' : '[W/m2]', 'comps': ['c', 'e', 'l'], 'bin_nr': 200, 'excl_thresh':'',
                   'c'   : {'fn': f'{thaao_c}_surface_net_solar_radiation_', 'column': 4, 'data': '', 'data_res': ''},
                   'e'   : {'fn': f'{thaao_e}_surface_net_solar_radiation_', 'column': 2, 'data': '', 'data_res': ''},
                   'l'   : {'fn': f'{thaao_l}_surface_net_solar_radiation_', 'column': 4, 'data': '', 'data_res': ''},
                   't'   : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                   't1'  : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                   't2'  : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'sw_up': {'name' : 'sw_up', 'ref_x': 't', 'min': 0, 'max': 600, 'res_min': -20, 'res_max': 20, 'uom': '[W/m2]',
                  ...
                  't1'   : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
                  't2'   : {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''}},
        'temp': {'name' : 'temp', 'ref_x': 't', 'min': -40, 'max': 20, 'res_min': -15, 'res_max': 15, 'uom': '[deg]',
                 'comps': ['c', 'e', 'l', 't2'], 'bin_nr': 200, 'excl_thresh':'',
        ...
        'tcc': {'name': 'tcc', 'ref_x': 't', 'min': 0, 'max': 1, 'res_min': -50, 'res_max': 50, 'uom': '[octave]',
                'comps': ['c', 'e'], 'bin_nr': 200,  'excl_thresh':'','c': {'fn': f'{thaao_c}_total_cloud_cover_', 'column': 2,
                'data'                                        : '', 'data_res': ''},
                'e': {'fn': f'{thaao_e}_total_cloud_cover_', 'column': 2, 'data': '', 'data_res': ''},
                'l': {'fn': '', 'column': np.nan, 'data': '', 'data_res': ''},
        ...
        'winds': {'name' : 'winds', 'ref_x': 't', 'min': 0, 'max': 30, 'res_min': -10, 'res_max': 10, 'uom': '[m/s]',
                  'comps': ['c', 'e', 'l', 't2'], 'bin_nr': 200, 'excl_thresh':'',
                  'c'    : {'fn': f'{thaao_c}_10m_wind_speed_', 'column': 2, 'data': pd.DataFrame(), 'data_res': ''},
        ...
        'windu': {'name': 'windd', 'ref_x': '', 'min': np.nan, 'max': np.nan, 'res_min': np.nan, 'res_max': np.nan,
                  'uom': '[m/s]', 'comps': [], 'bin_nr': np.nan, 'excl_thresh':'',
                  'c': {'fn': f'', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''},
                  'e': {'fn'    : f'{thaao_e}_10m_u_component_of_wind_', 'column': 4, 'data': pd.DataFrame(),
                      'data_res': ''},
                  'l': {'fn'    : f'{thaao_l}_10m_u_component_of_wind_', 'column': 4, 'data': pd.DataFrame(),
                      'data_res': ''}, 't': {'fn': '', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''},
                  't1': {'fn': '', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''},
                  't2': {'fn': 'AWS_THAAO_', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''}},
        'windv': {'name': 'winds', 'ref_x': 't', 'min': 0, 'max': 30, 'res_min': -10, 'res_max': 10, 'uom': '[m/s]',
                  'comps': [], 'bin_nr': 200, 'excl_thresh':'',
                  'c': {'fn': f'', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''},
                  'e': {'fn'    : f'{thaao_e}_10m_v_component_of_wind_', 'column': 2, 'data': pd.DataFrame(),
                      'data_res': ''},
                  'l': {'fn'    : f'{thaao_l}_10m_v_component_of_wind_', 'column': 2, 'data': pd.DataFrame(),
                      'data_res': ''}, 't': {'fn': '', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''},
                  't1': {'fn': '', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''},
                  't2': {'fn': 'AWS_THAAO_', 'column': np.nan, 'data': pd.DataFrame(), 'data_res': ''}}}
