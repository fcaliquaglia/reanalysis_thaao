...
##
tres = "12h"
list_var = ["ang"]  # , "lw_down", "sw_down"]  # "sw_down", "sw_up", "lw_down", "lw_up"]
...
extr = {"alb"      : {"name": "alb", "ref_x": "t", "min": 0, "max": 1, "res_min": -0.5, "res_max": 0.5,
                      ...
                      "c"   : {"fn"      : f"{thaao_c}_albedo_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "e"   : {"fn"      : f"{thaao_e}_forecast_albedo_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "l"   : {"fn"      : f"{thaao_l}_forecast_albedo_", "column": 4, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t"   : {"fn"      : "MERGED_SW_LW_UP_DW_METEO_", "column": "ALBEDO_SW", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()}},
        "cbh"      : {"name": "cbh", "ref_x": "t", "min": 0, "max": 10000, "res_min": -500, "res_max": 500,
                      "uom" : "[m]", "comps": ["c", "e"], "bin_nr": 200,
                      "c"   : {"fn"      : f"{thaao_c}_cloud_base_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
        ...
        "dewpt"    : {"name" : "dewpt", "ref_x": "", "min": "", "max": "", "res_min": "", "res_max": "", "uom": "[deg]",
                      ...
                      "c"    : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "e"    : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "l"    : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
        ...
        "lwp"      : {"name": "lwp", "ref_x": "t1", "min": 0, "max": 50, "res_min": -20, "res_max": 20,
                      ...
                      "l"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t1"  : {"fn"      : "LWP_15_min_", "column": np.nan, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t2"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()}},
        "lw_down"  : {"name": "lw_down", "ref_x": "t", "min": 0, "max": 500, "res_min": -20, "res_max": 20,
                      ...
                      "l"   : {"fn"  : f"{thaao_l}_surface_thermal_radiation_downwards_", "column": 4,
                               "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn"      : "MERGED_SW_LW_UP_DW_METEO_", "column": "LW_DOWN", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()}},
        ...
        "lw_up"    : {"name": "lw_up", "ref_x": "t", "min": 0, "max": 500, "res_min": -20, "res_max": 20,
                      "uom" : "[W/m2]", "comps": ["c", "e", "l"], "bin_nr": 200,
                      "c"   : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "e"   : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "l"   : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn"      : "MERGED_SW_LW_UP_DW_METEO_", "column": "LW_UP", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn": "", "column": 2, "data": pd.DataFrame(), "data_res": pd.DataFrame()}},
        "msl"      : {"name": "winds", "ref_x": "t", "min": 0, "max": 30, "res_min": -10, "res_max": 10,
                      "uom" : "[m/s]", "comps": ["c", "e", "t1", "t2"], "bin_nr": 200,
                      "c"   : {"fn"      : f"{thaao_c}_mean_sea_level_pressure_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "e"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "l"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
        ...
        "precip"   : {"name": "precip", "ref_x": "t2", "min": 0, "max": 5, "res_min": -10, "res_max": 10,
                      ...
                      "c"   : {"fn"      : f"{thaao_c}_total_precipitation_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "e"   : {"fn"      : f"{thaao_e}_total_precipitation_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "l"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn"      : "AWS_THAAO_", "column": "RH", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()}},
        "rh"       : {"name" : "rh", "ref_x": "", "min": 0, "max": 100, "res_min": -10, "res_max": 10, "uom": "[%]",
                      ...
                      "e"    : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "l"    : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"    : {"fn": "Meteo_weekly_all", "column": "RH_%", "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t1"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"   : {"fn"      : "AWS_THAAO_", "column": "RH", "data": pd.DataFrame(),
                                "data_res": pd.DataFrame()}},
        "surf_pres": {"name": "surf_pres", "ref_x": "t", "min": 925, "max": 1013, "res_min": -10, "res_max": 10,
                      "uom" : "[hPa]", "comps": ["c", "e", "t2"], "bin_nr": 200,
                      "c"   : {"fn"      : f"{thaao_c}_surface_pressure_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "e"   : {"fn"      : f"{thaao_e}_surface_pressure_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "l"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn"      : "Meteo_weekly_all", "column": "BP_hPa", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn"      : "AWS_THAAO_", "column": "BP_mbar", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()}},
        "sw_down"  : {"name": "sw_down", "ref_x": "t", "min": 0, "max": 500, "res_min": -20, "res_max": 20,
                      ...
                      "l"   : {"fn"  : f"{thaao_l}_surface_solar_radiation_downwards_", "column": 4,
                               "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn"      : "MERGED_SW_LW_UP_DW_METEO_", "column": "SW_DOWN", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()}},
        ...
        "sw_up"    : {"name": "sw_up", "ref_x": "t", "min": 0, "max": 500, "res_min": -20, "res_max": 20,
                      ...
                      "e"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "l"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn"      : "MERGED_SW_LW_UP_DW_METEO_", "column": "SW_UP", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()}},
        "temp": {"name"   : "temp", "ref_x": "t", "min": -40, "max": 20, "res_min": -10,
                 "res_max": 10, "uom": "[deg]", "comps": ["c", "e", "l", "t2"], "bin_nr": 200,
                 "c"      : {"fn"      : f"{thaao_c}_2m_temperature_", "column": 2, "data": pd.DataFrame(),
                             "data_res": pd.DataFrame()},
                 "e"      : {"fn"      : f"{thaao_e}_2m_temperature_", "column": 2, "data": pd.DataFrame(),
                             "data_res": pd.DataFrame()},
                 "l"      : {"fn"      : f"{thaao_l}_2m_temperature_", "column": 2, "data": pd.DataFrame(),
                             "data_res": pd.DataFrame()},
                 "t"      : {"fn"      : "Meteo_weekly_all", "column": "Air_K", "data": pd.DataFrame(),
                             "data_res": pd.DataFrame()},
                 "t1"     : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                 "t2"     : {"fn"      : "AWS_THAAO_", "column": "AirTC", "data": pd.DataFrame(),
                             "data_res": pd.DataFrame()}},
        "tcc"      : {"name": "tcc", "ref_x": "t", "min": 0, "max": 1, "res_min": -50, "res_max": 50,
                      "uom" : "[octave]", "comps": ["c", "e"], "bin_nr": 200,
                      "c"   : {"fn"      : f"{thaao_c}_total_cloud_cover_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
        ...
        "windd"    : {"name": "windd", "ref_x": "t", "min": 0, "max": 360, "res_min": -90, "res_max": 90,
                      ...
                      "c"   : {"fn"      : f"{thaao_c}_10m_wind_direction_", "column": 2, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
                      "e"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "l"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t"   : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t1"  : {"fn": "", "column": np.nan, "data": pd.DataFrame(), "data_res": pd.DataFrame()},
                      "t2"  : {"fn"      : "AWS_THAAO_", "column": "WD_aws", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()}},
        "winds"    : {"name": "winds", "ref_x": "t", "min": 0, "max": 30, "res_min": -10, "res_max": 10,
                      ...
                      "t2"  : {"fn"      : "AWS_THAAO_", "column": "WS_aws", "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()}},
        "windu"    : {"name": "windd", "ref_x": "t", "min": 0, "max": 30, "res_min": -10, "res_max": 10,
                      "uom" : "[m/s]", "comps": ["c", "e", "t", "t1"], "bin_nr": 200,
                      "c"   : {"fn"      : "", "column": np.nan, "data": pd.DataFrame(),
                               "data_res": pd.DataFrame()},
